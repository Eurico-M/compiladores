...
static const char *const yytname[] =
{
  ...
  "MULT", "DIV", "LPAREN", "RPAREN", "T_EOF", "'+'", "'-'", "'*'", "'/'",
  "$accept", "top", "expr", "term", YY_NULLPTR
};
...
{
      12,     1,     8,     9,    10,    11,     2,     8,     9,    10,
      11,    13,    14,    15,    16,     7,     6
};

static const yytype_int8 yycheck[] =
{
       9,     3,    11,    12,    13,    14,     8,    11,    12,    13,
      14,     8,     9,    10,    11,     0,     2
};
